...
app.addLabel("등록번호-2", "　",8,2)
app.addLabel("이름-1", "　",9,0)
app.addLabel("이름-2", "　",9,2)
app.addLabel("제조사/증상-1", "　",10,0)
app.addLabel("제조사/증상-2", "　",10,2)
app.addLabel("용도/복용방법-1", "　",11,0)
app.addLabel("용도/복용방법-2", "　",11,2)
app.addButton("약품 이미지 다운로드",imagedownload,12,1)
app.addButton("금지약물 위키피디아",openwiki,13,1)
app.addButton("이메일전송",sendemail,14,1)
app.go()
